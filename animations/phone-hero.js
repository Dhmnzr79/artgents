...
(function () {
  ...
  const dialogues = [
    [
      ...
      { role: 'user', text: 'Здравствуйте. Имплантация — это больно и сколько занимает?' },
      { role: 'bot', text: 'Процедура проходит под анестезией, поэтому боли обычно нет. Установка одного импланта в среднем занимает 20–40 минут.' },
